...
![Issues](https://img.shields.io/github/issues/puvvadaharshitha/laravel-smarthr)
![Forks](https://img.shields.io/github/forks/puvvadaharshitha/laravel-smarthr)
![Stars](https://img.shields.io/github/stars/puvvadaharshitha/laravel-smarthr)
...
```php
git clone https://github.com/puvvadaharshitha/laravel-smarthr.git smarthr
```
```
cd smarthr
...
##### Please note that, this project is under active development so few things might break when you update. You can report any of your issues [here](https://github.com/puvvadaharshitha/Laravel-Smarthr/issues)

Consider supporting the project if you finds it helpful. Thank you
- [Paystack](https://paystack.com/pay/puvvadaharshitha)
- [Paypal](https://www.paypal.com/paypalme/puvvadaharshitha)
- [Patreon](https://www.patreon.com/PuvvadaHarshitha)
