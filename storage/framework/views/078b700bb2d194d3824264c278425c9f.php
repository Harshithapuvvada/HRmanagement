...
<?php $component->withAttributes([]); ?>
    <a class="dropdown-item" href="javascript:void(0)" data-url="<?php echo e(route('departments.edit', $id)); ?>" data-ajax-modal="true"
        data-title="<?php echo e(__('Edit Department')); ?>" data-bs-toggle="tooltip" data-bs-title="<?php echo e(__('Edit Department')); ?>" data-size="md"><i class="fa-solid fa-pencil m-r-5"></i>
        <?php echo e(__('Edit')); ?>

    </a>
    <a class="dropdown-item deleteBtn" data-route="<?php echo e(route('departments.destroy', $id)); ?>" data-title="<?php echo e(__('Delete Department')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\harsh\Downloads\Laravel-Smarthr-main\Laravel-Smarthr-main\resources\views/pages/departments/actions.blade.php ENDPATH**/ ?>