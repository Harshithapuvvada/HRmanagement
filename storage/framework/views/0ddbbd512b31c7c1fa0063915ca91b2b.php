                            ...
                            <tbody>
                                <?php $__currentLoopData = $boards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" data-url="<?php echo e(route('task-boards.edit', $item->id)); ?>" data-ajax-modal="true"
                                                data-title="<?php echo e(__('Edit Task Board')); ?>" data-size="md"><i class="fa-solid fa-pencil"></i>
                                                <?php echo e(__('Edit')); ?>

                                            </a>

                                            <a class="deleteBtn ms-2" data-route="<?php echo e(route('task-boards.destroy', $item->id)); ?>" data-title="<?php echo e(__('Delete Task Board')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\harsh\Downloads\Laravel-Smarthr-main\Laravel-Smarthr-main\Modules/Project\resources/views/task-board/index.blade.php ENDPATH**/ ?>