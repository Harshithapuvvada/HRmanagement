                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="<?php echo e(route('employees.show', ['employee' => \Crypt::encrypt($employee->id)])); ?>" class="avatar"><img src="<?php echo e(!empty($employee->avatar) ? uploadedAsset($employee->avatar,'users'): asset('images/user.jpg')); ?>" alt="User Image"></a>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\harsh\Downloads\Laravel-Smarthr-main\Laravel-Smarthr-main\resources\views/pages/employees/index.blade.php ENDPATH**/ ?>